...
public class MainMenu : MonoBehaviour
{
    ...
    private void SetStartUpLogo()
    {
        gameLogo.GetComponent<CanvasGroup>().alpha = 0f;
        gameLogo.GetComponent<CanvasGroup>().DOFade(1, 1.5f).SetUpdate(true);
        gameLogo.GetComponent<RectTransform>().anchoredPosition = new Vector3(1200,130, 0);
        gameLogo.GetComponent<RectTransform>().DOAnchorPos(new Vector3(0, 130,0), 2f, false).SetEase(Ease.OutElastic).SetUpdate(true);
    }
